(function(){
  ...
  var LINKS = [
    ...
    { href: 'travel.html', label: 'travel', group: 'main' },
    { href: 'pepperdine.html', label: 'achieve', group: 'main' },
    ...
    { href: 'overview-tasks-interactive-mocks.html?v=1', label: 'overview tasks · interactive', group: 'design', parent: 'task-display-options.html' },
    { href: 'foil-lift-beyond-shadows-mocks.html?v=1', label: 'foil lift · beyond shadows', group: 'design' },
    { href: 'foil-bevel-more-mocks.html?v=2', label: 'foil lift · more height', group: 'design', parent: 'foil-lift-beyond-shadows-mocks.html?v=1' },
    { href: 'foil-float-glass-mocks.html?v=2', label: 'foil float · elevated titles', group: 'design', parent: 'foil-lift-beyond-shadows-mocks.html?v=1' },
    { href: 'adhd-table-mocks.html?v=1', label: 'ADHD · luxurious table', group: 'design' },
    { href: 'adhd-marble-tint-mocks.html?v=1', label: 'ADHD · white marble tints', group: 'design', parent: 'adhd-table-mocks.html?v=1' },
  ...
  function ensureStyles(){
    var css =
      ...
      'html body #nav-sidebar.open, html body.enh-dark #nav-sidebar.open { backdrop-filter: blur(5px) saturate(1.05) !important; -webkit-backdrop-filter: blur(5px) saturate(1.05) !important; }' +
